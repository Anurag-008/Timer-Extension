...
<div id="timer-extension-wrapper" >
    ...
    <div id="timer-extension-box">
        ...
        <button id="timer-extension-start" class="start_but" title="Start timer(ctrl+shift+Space)"></button>
        <button id="timer-extension-pause" title="Pause timer(ctrl+shift+Space)" class="timer-extension-hidden pause_but"></button>
        <button id="timer-extension-reset" class="reset_but" title="Reset timer(ctrl+shift+Q)"></button>
    </div>
    </div>
